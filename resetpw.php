...
<body>
    ...
    <div class="container">
        ...
        <h1>Reset Password</h1>
            <form action="resetac.php" method="post">
            ...
            <input type="password" id="input" class="pw" name="password" placeholder="New Password" required>
            <input type="password" id="input" class="pw" name="confirmpassword" placeholder="Confirm Password" required>
            <input type="submit" value="Reset Password" class="signup">
        </form>
    </div>
</body>
</html>